(defproject nasa-cmr/cmr-system-int-test "0.1.0-SNAPSHOT"
  ...
  :dependencies [[cheshire "5.13.0"] ;; done required from clj-http
                 [clj-http "3.13.0"] ;; done required from jetty-adapter
                 [clj-time "0.15.2"] ;; TODO required
                 [clj-xml-validation "1.0.2"]
                 [com.google.code.findbugs/jsr305 "3.0.2"]
                 [commons-codec/commons-codec "1.16.1"] ;; done
                 [org.apache.commons/commons-lang3 "3.17.0"]
                 [commons-io "2.19.0"] ;; done required
                 [crouton "0.1.2"]
                 [inflections "0.13.0"]
                 ...
                 [org.apache.httpcomponents/httpclient "4.5.14"] ;; done
                 [org.apache.httpcomponents/httpcore "4.4.16"] ;; done
                 [org.clojure/clojure "1.11.2"]
                 [org.clojure/tools.logging "1.3.0"] ;; done
                 [org.clojure/tools.reader "1.4.1"] ;; done
                 [org.jsoup/jsoup "1.17.2"] ;; done
                 [potemkin "0.4.7"]
