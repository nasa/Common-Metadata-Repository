(ns cmr.system-int-test.search.granule.granule-platform-instrument-sensor-search-test
...
(deftest search-by-platform-short-names
  (let [p0 (data-umm-cmn/platform {:ShortName "platform-Inherit"})
        ...
        coll1 (d/ingest-umm-spec-collection "PROV1" (data-umm-c/collection 1 {:Platforms [p1 p2 p3 p4]}) {:validate-keywords false})
        coll2 (d/ingest-umm-spec-collection "PROV1" (data-umm-c/collection 2 {:Platforms [p0 p5 p6 p7]}) {:validate-keywords false})
        gran1 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr1]}) {:validate-keywords false})
        gran2 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr1 pr2]}) {:validate-keywords false})
        gran3 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr2]}) {:validate-keywords false})
        gran4 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr3]}) {:validate-keywords false})
        gran5 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr4]}) {:validate-keywords false})
        gran6 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {}) {:validate-keywords false})
        gran7 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:platform-refs [pr5]}) {:validate-keywords false})
        gran8 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:platform-refs [pr6]}) {:validate-keywords false})
        gran9 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:platform-refs [pr7]}) {:validate-keywords false})]
...
(deftest search-by-instrument-short-names
  (let [i0 (data-umm-cmn/instrument {:ShortName "instrument-Inherit"})
        ...
        coll1 (d/ingest-umm-spec-collection "PROV1" (data-umm-c/collection 1 {:ShortName "SHORT1" :Platforms [p1 p2 p3 p4 p5]}) {:validate-keywords false})
        coll2 (d/ingest-umm-spec-collection "PROV1" (data-umm-c/collection 2 {:Platforms [p0 p6 p7 p8]}) {:validate-keywords false})
        gran1 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:granule-ur "gran1" :platform-refs [pr1]}) {:validate-keywords false})
        gran2 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:granule-ur "gran2" :platform-refs [pr1 pr2]}) {:validate-keywords false})
        gran3 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:granule-ur "gran3" :platform-refs [pr2]}) {:validate-keywords false})
        gran4 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:granule-ur "gran4" :platform-refs [pr3]}) {:validate-keywords false})
        gran5 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:granule-ur "gran5" :platform-refs [pr4]}) {:validate-keywords false})
        gran6 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:granule-ur "gran6" :platform-refs [pr5]}) {:validate-keywords false})
        gran7 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:granule-ur "gran7" }) {:validate-keywords false})
        gran8 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:granule-ur "gran8" :platform-refs [pr6]}) {:validate-keywords false})
        gran9 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:granule-ur "gran9" :platform-refs [pr7]}) {:validate-keywords false})
        gran10 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:granule-ur "gran10" :platform-refs [pr8]}) {:validate-keywords false})]
...
(deftest search-by-sensor-short-names
  (let [s0 (data-umm-cmn/instrument {:ShortName "sensor-Inherit"})
        ...
        coll1 (d/ingest-umm-spec-collection "PROV1" (data-umm-c/collection 1 {:Platforms [p1 p2 p3 p4 p5 p6]}) {:validate-keywords false})
        coll2 (d/ingest-umm-spec-collection "PROV1" (data-umm-c/collection 2 {:Platforms [p0 p7 p8 p9]}) {:validate-keywords false})
        gran1 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr1]}) {:validate-keywords false})
        gran2 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr1 pr2]}) {:validate-keywords false})
        gran3 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr2]}) {:validate-keywords false})
        gran4 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr3]}) {:validate-keywords false})
        gran5 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr4]}) {:validate-keywords false})
        gran6 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr5]}) {:validate-keywords false})
        gran7 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll1 (:concept-id coll1) {:platform-refs [pr6]}) {:validate-keywords false})
        gran8 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {}) {:validate-keywords false})
        gran9 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:platform-refs [pr7]}) {:validate-keywords false})
        gran10 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:platform-refs [pr8]}) {:validate-keywords false})
        gran11 (d/ingest "PROV1" (dg/granule-with-umm-spec-collection coll2 (:concept-id coll2) {:platform-refs [pr9]}) {:validate-keywords false})]
