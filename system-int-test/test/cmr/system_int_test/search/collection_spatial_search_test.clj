...
(deftest tile-search-test
  (testing "bounding box search"
    (u/are2 [wnes tiles]
            (assert_tiles_found {:bounding-box (codec/url-encode (apply m/mbr wnes))} tiles)
  ...
  (testing "polygon search"
    (u/are2 [ords tiles]
            (assert_tiles_found {:polygon (apply search-poly ords)} tiles)
  ...
  (testing "point search"
    (u/are2 [ords tiles]
            (assert_tiles_found {:point (codec/url-encode (apply p/point ords))} tiles)
