...
(deftest search-by-platform-short-names
  (let [p0 (data-umm-c/platform {:ShortName "platform-Inherit"})
        p1 (data-umm-c/platform {:ShortName "platform-Sn A"})
        p2 (data-umm-c/platform {:ShortName "platform-Sn B"})
        p3 (data-umm-c/platform {:ShortName "platform-SnA"})
        p4 (data-umm-c/platform {:ShortName "platform-Snx"})
        p5 (data-umm-c/platform {:ShortName "platform-ONE"})
        p6 (data-umm-c/platform {:ShortName "platform-x"})
        p7 (data-umm-c/platform {:ShortName "PLATform-X"})
...
(deftest search-by-instrument-short-names
  (let [i0 (data-umm-c/instrument {:ShortName "instrument-Inherit"})
        i01 (data-umm-c/instrument {:ShortName "instrument-ONE"})
        p0 (data-umm-c/platform {:ShortName "collection_platform" :Instruments [i0 i01]})
        i1 (data-umm-c/instrument {:ShortName "instrument-Sn A"})
        i2 (data-umm-c/instrument {:ShortName "instrument-Sn b"})
        i3 (data-umm-c/instrument {:ShortName "instrument-SnA"})
        i4 (data-umm-c/instrument {:ShortName "instrument-Snx"})
        i5 (data-umm-c/instrument {:ShortName "instrument-ONE"})
        i6 (data-umm-c/instrument {:ShortName "instrument-x"})
        i7 (data-umm-c/instrument {:ShortName "InstruMENT-X"})
        ...
        p1 (data-umm-c/platform {:ShortName "platform-1" :Instruments [i1]})
        p2 (data-umm-c/platform {:ShortName "platform-2" :Instruments [i2]})
        p3 (data-umm-c/platform {:ShortName "platform-3" :Instruments [i3]})
        p4 (data-umm-c/platform {:ShortName "platform-4" :Instruments [i4]})
        p5 (data-umm-c/platform {:ShortName "platform-5" :Instruments [i1 i2]})
        p6 (data-umm-c/platform {:ShortName "platform-6" :Instruments [i5]})
        p7 (data-umm-c/platform {:ShortName "platform-7" :Instruments [i6]})
        p8 (data-umm-c/platform {:ShortName "platform-8" :Instruments [i7]})
...
(deftest search-by-sensor-short-names
  (let [s0 (data-umm-c/instrument {:ShortName "sensor-Inherit"})
        s01 (data-umm-c/instrument {:ShortName "sensor-ONE"})
        i0 (data-umm-c/instrument {:ShortName "collection_instrument" :ComposedOf [s0 s01]})
        p0 (data-umm-c/platform {:ShortName "collection_platform" :Instruments [i0]})
        s1 (data-umm-c/instrument {:ShortName "sensor-Sn A"})
        s2 (data-umm-c/instrument {:ShortName "sensor-Sn b"})
        s3 (data-umm-c/instrument {:ShortName "sensor-SnA"})
        s4 (data-umm-c/instrument {:ShortName "sensor-Snx"})
        s5 (data-umm-c/instrument {:ShortName "sensor-ONE"})
        s6 (data-umm-c/instrument {:ShortName "sensor-x"})
        s7 (data-umm-c/instrument {:ShortName "SEnsor-X"})
        ...
        i1 (data-umm-c/instrument {:ShortName "instrument-1" :ComposedOf [s1]})
        i2 (data-umm-c/instrument {:ShortName "instrument-2" :ComposedOf [s2]})
        i3 (data-umm-c/instrument {:ShortName "instrument-3" :ComposedOf [s3]})
        i4 (data-umm-c/instrument {:ShortName "instrument-4" :ComposedOf [s4]})
        i5 (data-umm-c/instrument {:ShortName "instrument-5" :ComposedOf [s1 s2]})
        i6 (data-umm-c/instrument {:ShortName "instrument-6" :ComposedOf [s5]})
        i7 (data-umm-c/instrument {:ShortName "instrument-7" :ComposedOf [s6]})
        i8 (data-umm-c/instrument {:ShortName "instrument-8" :ComposedOf [s7]})
        ...
        p3 (data-umm-c/platform {:ShortName "platform-3" :Instruments [i3]})
        p4 (data-umm-c/platform {:ShortName "platform-4" :Instruments [i4]})
        p5 (data-umm-c/platform {:ShortName "platform-5" :Instruments [i5]})
        p6 (data-umm-c/platform {:ShortName "platform-6" :Instruments [i1 i2]})
        p7 (data-umm-c/platform {:ShortName "platform-7" :Instruments [i6]})
        p8 (data-umm-c/platform {:ShortName "platform-8" :Instruments [i7]})
        p9 (data-umm-c/platform {:ShortName "platform-9" :Instruments [i8]})
        pr1 (dg/platform-ref {:short-name "platform-1" :instrument-refs [ir1]})
        pr2 (dg/platform-ref {:short-name "platform-2" :instrument-refs [ir2]})
        pr3 (dg/platform-ref {:short-name "platform-3" :instrument-refs [ir3]})
        pr4 (dg/platform-ref {:short-name "platform-4" :instrument-refs [ir4]})
