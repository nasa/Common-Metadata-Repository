...
(deftest search-by-platform-short-names
  (let [p0 (dc/platform {:short-name "platform-Inherit"})
        p1 (dc/platform {:short-name "platform-Sn A"})
        p2 (dc/platform {:short-name "platform-Sn B"})
        p3 (dc/platform {:short-name "platform-SnA"})
        p4 (dc/platform {:short-name "platform-Snx"})
        p5 (dc/platform {:short-name "platform-ONE"})
        p6 (dc/platform {:short-name "platform-x"})
        p7 (dc/platform {:short-name "PLATform-X"})
...
(deftest search-by-instrument-short-names
  (let [i0 (dc/instrument {:short-name "instrument-Inherit"})
        ...
        p0 (dc/platform {:short-name "collection_platform" :instruments [i0 i01]})
        ...
        p1 (dc/platform {:short-name "platform-1" :instruments [i1]})
        p2 (dc/platform {:short-name "platform-2" :instruments [i2]})
        p3 (dc/platform {:short-name "platform-3" :instruments [i3]})
        p4 (dc/platform {:short-name "platform-4" :instruments [i4]})
        p5 (dc/platform {:short-name "platform-5" :instruments [i1 i2]})
        p6 (dc/platform {:short-name "platform-6" :instruments [i5]})
        p7 (dc/platform {:short-name "platform-7" :instruments [i6]})
        p8 (dc/platform {:short-name "platform-8" :instruments [i7]})
...
(deftest search-by-sensor-short-names
  (let [s0 (dc/sensor {:short-name "sensor-Inherit"})
        ...
        p0 (dc/platform {:short-name "collection_platform" :instruments [i0]})
        ...
        p3 (dc/platform {:short-name "platform-3" :instruments [i3]})
        p4 (dc/platform {:short-name "platform-4" :instruments [i4]})
        p5 (dc/platform {:short-name "platform-5" :instruments [i5]})
        p6 (dc/platform {:short-name "platform-6" :instruments [i1 i2]})
        p7 (dc/platform {:short-name "platform-7" :instruments [i6]})
        p8 (dc/platform {:short-name "platform-8" :instruments [i7]})
        p9 (dc/platform {:short-name "platform-9" :instruments [i8]})
        pr1 (dg/platform-ref "platform-1" ir1)
        pr2 (dg/platform-ref "platform-2" ir2)
        pr3 (dg/platform-ref "platform-3" ir3)
        pr4 (dg/platform-ref "platform-4" ir4)
