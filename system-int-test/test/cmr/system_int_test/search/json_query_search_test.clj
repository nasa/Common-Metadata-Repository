...
(deftest validation-test
  (testing "Invalid JSON condition names"
    (are [concept-type search-map error-message]
         ...
         ["/not/or/1 object instance has properties which are not allowed by the schema: [\"not-right\"]"]
  ...
  (testing "Invalid science keyword parameters"
    (is (= {:status 400
            :errors ["/science_keywords object instance has properties which are not allowed by the schema: [\"and\",\"not\"]"]}
  ...
  (testing "Concept-id does not support case-insensitive searches"
    (is (= {:status 400
            :errors ["/concept_id instance failed to match exactly one schema (matched 0 out of 2)"
                     "/concept_id instance type (object) does not match any allowed primitive type (allowed: [\"string\"])"
                     "/concept_id object instance has properties which are not allowed by the schema: [\"ignore_case\"]"]}
