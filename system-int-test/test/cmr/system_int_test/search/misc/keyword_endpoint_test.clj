(ns cmr.system-int-test.search.misc.keyword-endpoint-test
...
(def expected-hierarchy
  ...
  {:archive-centers {"level_0"
   ...
   :granule-data-format {"short_name"
                         [{"value" "HDF4", "uuid" "e5c126f8-0435-4cef-880f-72a1d2d792f2"}
                          {"value" "ZIP", "uuid" "5c406abc-104d-4517-96b8-dbbcf515f00f"}
                          {"value" "PNG", "uuid" "4c406abc-104d-4517-96b8-dbbcf515f00f"}
                          {"value" "HDF5", "uuid" "1c406abc-104d-4517-96b8-dbbcf515f00f"}
                          {"value" "NETCDF-CF", "uuid" "3c406abc-104d-4517-96b8-dbbcf515f00f"}
                          {"value" "JPEG", "uuid" "7443bb2d-1dbb-44d1-bd29-0241d30fbc57"}
                          {"value" "ASCII", "uuid" "8e128326-b9cb-44c7-9e6b-4bd950a08753"}
                          {"value" "CSV", "uuid" "465809cc-e76c-4630-8594-bb8bd7a1a380"}
                          {"value" "netCDF-4", "uuid" "30ea4e9a-4741-42c9-ad8f-f10930b35294"}
                          {"value" "HTML", "uuid" "2c406abc-104d-4517-96b8-dbbcf515f00f"}]}
    :mime-type {"mime_type"
                [{"value" "text/csv", "uuid" "2065aabb-9beb-4c84-8ad7-0e16cfed17cf"}
                 {"value" "application/tar+gzip",
                  "uuid" "43ca8ee0-04a5-4020-b0ec-998ec0e0f30e"}
                 {"value" "application/json",
                  "uuid" "8542dd4a-a11b-475d-8d46-cad785a7f510"}
                 {"value" "text/css", "uuid" "3195dfce-51db-4b40-aadb-808b43573743"}
                 ...
                 {"value" "image/png", "uuid" "edb9e800-ec31-4d5c-848d-c548fd151db2"}
                 {"value" "text/xml", "uuid" "091b6afc-ab75-4790-8e71-3b32ae8bd0a4"}
                 {"value" "image/gif", "uuid" "ad61b259-8131-4e0e-aac8-a800a0a51ca6"}
                 ...
                 {"value" "image/bmp", "uuid" "b7687b8f-7a24-4150-bd9d-28e0d53f7554"}
                 ...
                 {"value" "text/html", "uuid" "415a10b5-7286-4195-a88e-00c7b995b7d0"}
    ...
    :processing-levels {"processing_level"
                        [{"value" "1T", "uuid" "f0adb8af-d267-48e5-bf19-7a1ac0c62b33"}
                         {"value" "2P", "uuid" "f14f5874-765a-4d2b-af98-f681c870ec61"}
                         {"value" "2A", "uuid" "7f4a899c-0273-4a1d-8928-2fd71ceecaa6"}
                         {"value" "2B", "uuid" "ef126a1a-e2b7-4ddf-acd9-ecf743d35760"}
                         {"value" "3", "uuid" "808cdb91-d7eb-4625-96c5-0e2caed61636"}
                         {"value" "3A", "uuid" "04c81482-22a0-4899-91f2-0cc3f0ef6db4"}
                         {"value" "NA", "uuid" "b85956c5-19b8-4e2a-bdae-358f9f1be0ab"}
                         {"value" "2", "uuid" "6bd06926-fde3-45f1-8895-678416d854f6"}
                         {"value" "1C", "uuid" "e208ff78-0860-4717-bc52-8c02e4abec19"}
                         {"value" "1", "uuid" "a930f39b-a41f-4122-8a79-c800960ffda5"}
                         {"value" "2G", "uuid" "3797d495-1849-4c33-bdb6-50e40d5b74e4"}
                         {"value" "1B", "uuid" "133f0bed-a48c-4a1a-8790-4f2485a55a4f"}
                         {"value" "4", "uuid" "af090ded-5f1f-49bd-96ef-ebe2f4227e69"}
                         {"value" "Not provided", "uuid" "acb6dc53-b39d-4590-8963-9cf2fa624b6a"}
                         {"value" "0", "uuid" "b58fa5bb-dfc7-4d6c-b240-161fe44c15d3"}
...
(deftest get-keywords-test
  (util/are3
    ...
    "Testing correct keyword heirarchy returned for processing-levels"
    :processing-levels (:processing-levels expected-hierarchy)))
  ...
  (testing "Invalid keyword scheme returns 400 error"
    (is (= {:status 400
            :errors [(str "The keyword scheme [foo] is not supported. Valid schemes are:"
                          ...
                          " processing_levels, archive_centers, data_centers, location_keywords, and projects.")]}
