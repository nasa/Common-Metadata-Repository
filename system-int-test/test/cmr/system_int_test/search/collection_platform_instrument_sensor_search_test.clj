...
(deftest search-by-sensor-short-names
  (let [s1 (dc/sensor "sensor_Sn A")
        ...
        i1 (dc/instrument "instrument_1" nil nil s1)
        i2 (dc/instrument "instrument_2" nil nil s2)
        i3 (dc/instrument "instrument_3" nil nil s3)
        i4 (dc/instrument "instrument_4" nil nil s4)
