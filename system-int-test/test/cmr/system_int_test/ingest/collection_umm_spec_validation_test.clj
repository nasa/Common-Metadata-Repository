...
(deftest umm-spec-validation-warnings
  ...
  (testing "Ingest and Ingest Validation with warning messages for all formats"
    (are3 [format collection warning-message]
          ...
          :umm-json (collection-invalid-data-date-ranges) "After translating item to UMM-C the metadata had the following issue: [:MetadataDates] UPDATE date value: [2049-01-01T00:00:00.000Z] should be in the past. REVIEW date value: [2011-01-01T00:00:00.000Z] should be in the future. Earliest DELETE date value: [2049-01-01T00:00:00.000Z] should be later than REVIEW date value: [2050-01-01T00:00:00.000Z].After translating item to UMM-C the metadata had the following issue: [:DataDates] CREATE date value: [2050-01-01T00:00:00.000Z] should be in the past. UPDATE date value: [2049-01-01T00:00:00.000Z] should be in the past. REVIEW date value: [2011-01-01T00:00:00.000Z] should be in the future. Earliest UPDATE date value: [2011-01-01T00:00:00.000Z] should be later than CREATE date value: [2050-01-01T00:00:00.000Z]."
