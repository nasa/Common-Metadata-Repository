...
(deftest get-latest-by-concept-id
  (let [coll1 (util/create-and-save-collection "REG_PROV" 1 3)
        ...
        coll3 (util/create-and-save-collection "SMAL_PROV" 3 3)
...
(deftest find-collections
  (let [coll1 (util/create-and-save-collection "REG_PROV" 1)
        ...
        coll3 (util/create-and-save-collection "SMAL_PROV" 3)
  ...
  (let [coll4 (util/create-and-save-collection "REG_PROV" 4 3)
...
(deftest get-expired-collections-concept-ids
  (let [time-now (tk/now)
        ...
        coll5 (make-coll-expiring-in "SMAL_PROV" 5 1 -60)]

    (testing "get expired collection concept ids"
      (let [{:keys [status concept-ids]} (util/get-expired-collection-concept-ids "REG_PROV")]
        (is (= [200 (set (map :concept-id [coll1 coll2]))]
