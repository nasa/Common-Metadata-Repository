...
(deftest old-granule-revisions-are-cleaned-up
  (let [coll1 (util/create-and-save-collection "REG_PROV" 1 1)
        gran1 (util/create-and-save-granule
                "REG_PROV" (:concept-id coll1) (get-in coll1 [:extra-fields :entry-title]) 1 3)
        gran2 (util/create-and-save-granule
                "REG_PROV" (:concept-id coll1) (get-in coll1 [:extra-fields :entry-title]) 2 3)
        coll2 (util/create-and-save-collection "SMAL_PROV1" 2 1)
        gran3 (util/create-and-save-granule
                "SMAL_PROV1" (:concept-id coll2) (get-in coll2 [:extra-fields :entry-title]) 1 3 {:native-id "foo"})
        gran4 (util/create-and-save-granule
                "SMAL_PROV1" (:concept-id coll2) (get-in coll2 [:extra-fields :entry-title]) 4 2)
        coll3 (util/create-and-save-collection "SMAL_PROV2" 2 1)
        gran5 (util/create-and-save-granule
                "SMAL_PROV2" (:concept-id coll3) (get-in coll3 [:extra-fields :entry-title]) 1 12 {:native-id "foo"})
...
(deftest old-tombstones-are-cleaned-up
  (let [coll1 (util/create-and-save-collection "REG_PROV" 1)
        ...
        make-gran (fn [uniq-num offset-days]
                    (let [gran (assoc (util/granule-concept
                                        "REG_PROV" (:concept-id coll1)
                                        (get-in coll1 [:extra-fields :entry-title]) uniq-num)
