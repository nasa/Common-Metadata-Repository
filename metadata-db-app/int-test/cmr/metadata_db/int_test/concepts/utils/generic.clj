...
(defmethod concepts/get-sample-metadata :dataqualitysummary
  [_concept-type]
  (json/generate-string
   {:Id "8EA5CA1F-E339-8065-26D7-53B64074D7CC",
    :Name "CER-BDS_Terra",
    :Summary "Summary",
    :MetadataSpecification {:Name "DataQualitySummary",
                            :Version "1.0.0",
                            :URL "https://cdn.earthdata.nasa.gov/generics/dataqualitysummary/v1.0.0"}}))

(defmethod concepts/create-concept :dataqualitysummary
  [concept-type & args]
