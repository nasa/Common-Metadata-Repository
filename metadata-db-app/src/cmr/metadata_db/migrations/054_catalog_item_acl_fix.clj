(ns cmr.metadata-db.migrations.054-catalog-item-acl-fix
  (:require
...
(defn up
  ...
  []
  (println "cmr.metadata-db.migrations.054-add-coll-ids-catalog-acls up...")
...
(defn down
  ...
  []
  (println "cmr.metadata-db.migrations.054-add-coll-ids-catalog-acls down..."))
