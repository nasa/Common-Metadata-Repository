...
(defn up
  ...
  (h/sql "ALTER TABLE CMR_ASSOCIATIONS ADD COLUMN source_revision_id INTEGER NULL")
  (h/sql "ALTER TABLE CMR_ASSOCIATIONS ALTER COLUMN association_type TYPE VARCHAR(80)"))
