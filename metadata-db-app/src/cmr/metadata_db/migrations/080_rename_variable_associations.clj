(ns cmr.metadata-db.migrations.080-rename-variable-associations
  (:require
   [config.mdb-migrate-helper :as h]))

(defn up
  "Migrates the database up to version 80."
  []
  (println "cmr.metadata-db.migrations.080-rename-variable-associations up...")
...
(defn down
  "Migrates the database down from version 80."
  []
  (println "cmr.metadata-db.migrations.080-rename-variable-associations down...")
