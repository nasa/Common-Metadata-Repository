...
(defn up
  ...
  (h/sql "ALTER TABLE CMR_VARIABLE_ASSOCIATIONS ADD COLUMN ASSOCIATION_TYPE VARCHAR(30) DEFAULT 'VARIABLE-COLLECTION' NOT NULL")
  ...
  (h/sql "ALTER SEQUENCE CMR_VARIABLE_ASSOCIATIONS_SEQ RENAME TO CMR_ASSOCIATIONS_SEQ"))
