...
(defn up
  ...
  (h/sql "alter table METADATA_DB.cmr_variables modify variable_name VARCHAR(256) NOT NULL"))
...
(defn down
  ...
  (h/sql "update METADATA_DB.cmr_variables set variable_name = substr(variable_name,1,256)")
