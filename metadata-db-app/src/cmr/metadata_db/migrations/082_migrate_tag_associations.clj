...
(defn up
  ...
  (h/sql "INSERT INTO CMR_ASSOCIATIONS (ID,CONCEPT_ID,NATIVE_ID,METADATA,FORMAT,REVISION_ID,ASSOCIATED_CONCEPT_ID,ASSOCIATED_REVISION_ID,REVISION_DATE,DELETED,USER_ID,TRANSACTION_ID,SOURCE_CONCEPT_IDENTIFIER,ASSOCIATION_TYPE)
          SELECT nextval('CMR_ASSOCIATIONS_SEQ'),CONCEPT_ID,NATIVE_ID,METADATA,FORMAT,REVISION_ID,ASSOCIATED_CONCEPT_ID,ASSOCIATED_REVISION_ID,REVISION_DATE,DELETED,USER_ID,TRANSACTION_ID,TAG_KEY,'TAG-COLLECTION'
...
(defn down
  ...
  (h/sql "DELETE FROM CMR_ASSOCIATIONS_OLD WHERE ASSOCIATION_TYPE='TAG-COLLECTION'")
