(ns migrations.013-add-granule-index-with-revision-date
...
(defn up
  []
  (println "migrations.013-add-granule-index-with-revision-date up...")
...
(defn down
  []
  (println "migrations.013-add-granule-index-with-revision-date down...")
  (doseq [t (h/get-regular-provider-granule-tablenames)]
