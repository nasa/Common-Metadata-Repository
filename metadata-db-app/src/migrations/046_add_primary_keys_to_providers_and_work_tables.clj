(ns migrations.046-add-primary-keys-to-providers-and-work-tables
  "Adds primary keys to three database tables."
  (:require [config.mdb-migrate-helper :as h]))

(defn up
  "Migrates the database up to version 46."
  []
  (println "migrations.046-add-primary-keys-to-providers-and-work-tables up...")
...
(defn down
  ...
  []
  (println "migrations.046-add-primary-keys-to-providers-and-work-tables down...")
