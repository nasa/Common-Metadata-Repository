(ns migrations.063-reorder-variable-constraint
  (:require
...
(defn up
  ...
  []
  (println "migrations.063-reorder-variable-constraint up...")
  (drop-constraint)
  (add-new-constraint))
...
(defn down
  ...
  []
  (println "migrations.063-reorder-variable-constraint down...")
  (drop-constraint)
