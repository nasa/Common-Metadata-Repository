(ns migrations.021-setup-provider-services-tables
...
(defn up
  ...
  []
  (println "migrations.021-setup-provider-services-tables up...")
...
(defn down
  ...
  []
  (println "migrations.021-setup-provider-services-tables down...")
  (doseq [provider (h/get-regular-providers)
