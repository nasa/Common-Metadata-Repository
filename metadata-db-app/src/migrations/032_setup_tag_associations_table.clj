(ns migrations.032-setup-tag-associations-table
...
(defn up
  ...
  []
  (println "migrations.032-setup-tag-associations-table up...")
...
(defn down
  ...
  []
  (println "migrations.032-setup-tag-associations-table down...")
