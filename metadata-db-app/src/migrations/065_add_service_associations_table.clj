(ns migrations.065-add-service-associations-table
  (:require
...
(defn up
  ...
  []
  (println "migrations.065-add-service-associations-table up...")
...
(defn down
  ...
  []
  (println "migrations.065-add-service-associations-table down...")
