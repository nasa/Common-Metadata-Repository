(ns migrations.053-fix-catalog-acl-concept-ids
...
(defn up
  ...
  []
  (println "migrations.053-fix-catalog-acl-concept-ids up...")
...
(defn down
  ...
  []
  (println "migrations.053-fix-catalog-acl-concept-ids down..."))
