(ns migrations.014-add-granule-index-with-revision-date
...
(defn up
  []
  (println "migrations.014-add-granule-index-with-revision-date up...")
...
(defn down
  []
  (println "migrations.014-add-granule-index-with-revision-date down...")
  (doseq [t (h/get-granule-tablenames)]
