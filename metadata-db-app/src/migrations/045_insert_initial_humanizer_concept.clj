(ns migrations.045-insert-initial-humanizer-concept
...
(defn up
  ...
  []
  (println "migrations.045-insert-initial-humanizer-concept up...")
...
(defn down
  ...
  []
  (println "migrations.045-insert-initial-humanizer-concept down...")
  (h/sql "DELETE cmr_humanizers"))
