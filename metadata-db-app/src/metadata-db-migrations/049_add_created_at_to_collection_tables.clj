(ns migrations.049-add-created-at-to-collection-tables
...
(defn up
  ...
  []
  (println "migrations.049-add-created-at-to-collection-tables up...")
  (add-created-at)
  (set-created-at))
...
(defn down
  ...
  []
  (println "migrations.049-add-created-at-to-collection-tables down...")
  (doseq [t (h/get-collection-tablenames)]
