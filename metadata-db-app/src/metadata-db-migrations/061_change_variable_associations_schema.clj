(ns migrations.061-change-variable-associations-schema
  (:require
...
(defn up
  ...
  []
  (println "migrations.061-change-variable-associations-schema up...")
...
(defn down
  ...
  []
  (println "migrations.061-change-variable-associations-schema down...")
