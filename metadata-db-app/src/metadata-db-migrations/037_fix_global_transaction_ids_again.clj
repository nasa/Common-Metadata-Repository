(ns migrations.037-fix-global-transaction-ids-again
...
(defn up
  ...
  []
  (println "migrations.037-fix-global-transaction-ids-again up...")
...
(defn down
  ...
  []
  (println "migrations.037-fix-global-transaction-ids-again down...")
