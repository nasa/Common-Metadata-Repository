(ns migrations.022-setup-small-provider-services-table
...
(defn up
  ...
  []
  (println "migrations.022-setup-small-provider-services-table up...")
...
(defn down
  ...
  []
  (println "migrations.022-setup-small-provider-services-table down...")
