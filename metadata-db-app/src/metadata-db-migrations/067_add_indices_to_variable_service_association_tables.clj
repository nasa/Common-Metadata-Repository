(ns migrations.067-add-indices-to-variable-service-association-tables
  (:require
...
(defn up
  ...
  []
  (println "migrations.067-add-indices-to-variable-service-association-tables up...")
...
(defn down
  ...
  []
  (println "migrations.067-add-indices-to-variable-service-association-tables down...")
