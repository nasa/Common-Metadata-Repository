(ns cmr.umm-spec.umm-to-xml-mappings.iso-smap.instrument
  "Functions for generating ISOSMAP XML elements from UMM instrument records."
  (:require 
    [cmr.common.xml.gen :refer :all]
    [cmr.umm-spec.iso19115-2-util :as iso]
    [cmr.umm-spec.iso-keywords :as kws]
    [cmr.umm-spec.umm-to-xml-mappings.iso-smap.characteristics-and-operationalmodes :as ch]
    [cmr.umm-spec.umm-to-xml-mappings.iso-smap.sensor :as sensor]
