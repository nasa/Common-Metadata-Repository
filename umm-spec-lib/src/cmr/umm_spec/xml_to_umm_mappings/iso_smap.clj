  ...
  (let [data-id-el (first (select doc md-identification-base-xpath))
    ...
    (js/parse-umm-c
      {:ShortName (value-of data-id-el short-name-xpath)
       ...
       :Abstract (u/truncate (value-of short-name-el "gmd:abstract/gco:CharacterString") u/ABSTRACT_SIZE sanitize?)
       :Purpose (u/truncate (value-of short-name-el "gmd:purpose/gco:CharacterString") u/PURPOSE_SIZE sanitize?)
