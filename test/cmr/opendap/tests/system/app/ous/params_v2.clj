  ...
  (testing "GET with variables, graules, and bounding box ..."
    (let [collection-id "C1200267318-HMR_TME"
          response @(httpc/get
                     ...
                     (request/add-token-header {} (util/get-sit-token)))]
      (is (= 200 (:status response)))
      (is (= ["https://acdisc.gesdisc.eosdis.nasa.gov/opendap/Aqua_AIRS_Level3/AIRX3STD.006/2002/AIRS.2002.09.04.L3.RetStd001.v6.0.9.0.G13208020620.hdf.nc?CH4_VMR_A[0:1:23][22:1:70][169:1:236],Latitude[22:1:70],Longitude[169:1:236]"]
             (util/parse-response response))))))
