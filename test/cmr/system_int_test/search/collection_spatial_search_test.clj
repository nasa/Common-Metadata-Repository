  ...
  (let [make-coll (fn [coord-sys orbit-params et & shapes]
    ...
    (testing "line searches"
      (are [ords items]
           ...
           ;; normal two points
           [-24.28,-12.76,10,10] [whole-world west-hemi-poly1 west-hemi-poly2 east-hemi-poly1
                                  polygon-with-holes normal-poly normal-brs]

           ;; normal multiple points
           [-0.37,-14.07,4.75,1.27,25.13,-15.51] [whole-world polygon-with-holes
                                                  west-hemi-poly1 west-hemi-poly2 east-hemi-poly1
    ...
    (testing "point searches"
      (are [lon_lat items]
           ...
           [4.83 1.06] [whole-world east-hemi-poly1]
           ;; in hole of polygon with a hole
           [1.67 5.43] [whole-world east-hemi-poly1]
           ;; and not in hole
           [1.95 3.36] [whole-world polygon-with-holes east-hemi-poly1]

           ;; in mbr
           [17.73 2.21] [whole-world normal-brs east-hemi-poly1]

           ;;matches exact point on polygon
           [-5.26 -2.59] [whole-world polygon-with-holes west-hemi-poly1 west-hemi-poly2]

           ;; Matches a granule point
           [10 22] [whole-world normal-point wide-north-cart east-hemi-poly1]

           [-154.821 37.84] [whole-world very-wide-cart very-tall-cart
                             west-hemi-poly1 west-hemi-poly2]
           ...
           [2.185,-11.161] [whole-world normal-poly-cart east-hemi-poly1]

           ;; inside a hole in the cartesian polygon
           [4.496,-18.521] [whole-world east-hemi-poly1]

           ;; point on geodetic line
           [20.0 -10.437310310746927] [whole-world normal-line east-hemi-poly1]
           ;; point on cartesian line
           [20.0 -13.496157710960231] [whole-world normal-line-cart east-hemi-poly1]))
    ...
    (testing "bounding rectangle searches"
      (are [wnes items]
           ...
           [4.03,1.51,4.62,0.92] [whole-world east-hemi-poly1]
           ;; corner points inside different holes
           [4.03,5.94,4.35,0.92] [whole-world polygon-with-holes east-hemi-poly1]
           ...
           [-1.82,46.56,5.25,44.04] [whole-world west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]
           [-1.74,46.98,5.25,44.04] [whole-world wide-north west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]
           [-1.74 47.05 5.27 44.04] [whole-world wide-north west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]
           ...
           [-10 90 10 -90] [whole-world on-np on-sp wide-north wide-south polygon-with-holes
                            ...
                            polygon-with-holes-cart west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]
           ...
           [17.67,-4,25.56,-6.94] [whole-world normal-line east-hemi-poly1]

           ;; Matches cartesian line
           [23.59,-4,25.56,-15.47] [whole-world normal-line-cart east-hemi-poly1]
    ...
    (testing "polygon searches"
      (are [ords items]
           ...
           [whole-world on-np wide-north very-wide-cart west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]
           ...
           [whole-world normal-line normal-line-cart normal-brs east-hemi-poly1]

           ;; Intersects both lines
           [23.33,-14.96,24.02,-14.69,19.73,-6.81,18.55,-6.73,23.33,-14.96]
           [whole-world normal-line normal-line-cart east-hemi-poly1]

           ;; Related to the geodetic polygon with the holes
           ;; Inside holes
           [4.1,0.64,4.95,0.97,6.06,1.76,3.8,1.5,4.1,0.64] [whole-world east-hemi-poly1]
           [1.41,5.12,3.49,5.52,2.66,6.11,0.13,6.23,1.41,5.12] [whole-world east-hemi-poly1]
           ;; Partially inside a hole
           [3.58,-1.34,4.95,0.97,6.06,1.76,3.8,1.5,3.58,-1.34]
           [whole-world polygon-with-holes east-hemi-poly1]
           ;; Covers a hole
           ...
           [whole-world polygon-with-holes normal-brs west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]

           ;; Related to the cartesian polygon with the holes
           ;; Inside holes
           [-1.39,-14.32,2.08,-14.38,1.39,-13.43,-1.68,-13.8,-1.39,-14.32]
           [whole-world normal-poly-cart west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]
           ;; Partially inside a hole
    ...
    (testing "AQL spatial search"
      (are [type ords items]
           ...
           :box [23.59,-4,25.56,-15.47] [whole-world normal-line-cart east-hemi-poly1]
           :point [17.73 2.21] [whole-world normal-brs east-hemi-poly1]
           :line [-0.37,-14.07,4.75,1.27,25.13,-15.51]
           [whole-world polygon-with-holes polygon-with-holes-cart normal-line-cart normal-line
            normal-poly-cart  west-hemi-poly1 west-hemi-poly2 east-hemi-poly1]))))
