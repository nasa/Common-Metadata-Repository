...
(deftest search-by-platform-short-names
  (let [p1 (dc/platform "platform_Sn A")
        ...
        coll (d/ingest "CMR_PROV1" (dc/collection {:platforms [p1 p2 p3 p4]}))
        gran1 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr1]}))
        gran2 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr1 pr2]}))
        gran3 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr2]}))
        gran4 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr3]}))
        gran5 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr4]}))
...
(deftest search-by-instrument-short-names
  (let [i1 (dg/instrument-ref "instrument_Sn A")
        ...
        gran4 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr3]}))
        gran5 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr4]}))
        gran6 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [pr5]}))
        gran7 (d/ingest "CMR_PROV1" (dg/granule coll {}))]
...
(deftest search-by-sensor-short-names
  (let [s1 (dg/sensor-ref "sensor_Sn A")
        ...
        coll (d/ingest "CMR_PROV1" (dc/collection {}))
        gran1 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [p1]}))
        gran2 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [p1 p2]}))
        gran3 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [p2]}))
        gran4 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [p3]}))
        gran5 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [p4]}))
        gran6 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [p5]}))
        gran7 (d/ingest "CMR_PROV1" (dg/granule coll {:platform-refs [p6]}))
        gran8 (d/ingest "CMR_PROV1" (dg/granule coll {}))]
