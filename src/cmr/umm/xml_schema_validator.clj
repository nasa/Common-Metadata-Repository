...
(let [g3-xml "<Granule>
  ...
  (cmr.common.xml/string-at-path coll-elem-content [:VersionId])
  )


(let [c1-xml "<Collection>
          <ShortName>MINIMAL</ShortName>
          <VersionId>1</VersionId>
          <InsertTime>1999-12-31T19:00:00-05:00</InsertTime>
          <LastUpdate>1dd999-12-31T19:00:00-05:00</LastUpdate>
          ...
          xml-struct (clojure.data.xml/parse-str c1-xml)
      content (cmr.common.xml/content-at-path xml-struct [:Collection])]
