(ns cmr.metadata-db.data.oracle-concept-store
  "Addes ConceptStore methods to OracleStore."
  (:require [cmr.metadata-db.data.oracle :as oracle]
            [cmr.metadata-db.data :as data]
...
(defn- reset-database
  "Delete everything and reset the concept sequence."
  [db]
  ;; TODO - find all the providers and remove their concept tables
