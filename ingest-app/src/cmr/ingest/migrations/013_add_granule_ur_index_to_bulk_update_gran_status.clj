...
(defn up
  ...
  []
  (println "cmr.ingest.migrations.090-add-granule-ur-index-to-bulk-update-gran-status up...")
...
(defn down
  ...
  []
  (println "cmr.ingest.migrations.090-add-granule-ur-index-to-bulk-update-gran-status down...")
