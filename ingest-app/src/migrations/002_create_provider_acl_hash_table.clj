(ns migrations.002-create-provider-acl-hash-table
...
(defn up
  ...
  []
  (println "migrations.002-create-provider-acl-hash-table up...")
...
(defn down
  ...
  []
  (println "migrations.002-create-provider-acl-hash-table down...")
