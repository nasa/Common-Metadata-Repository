...
```
CMR_DB_URL=thin:@localhost:1521:orcl CMR_METADATA_DB_PASSWORD=CMR_INGEST java -cp target/cmr-ingest-app-0.1.0-SNAPSHOT-standalone.jar cmr.db create-user
```

2. Run db migration

```
CMR_DB_URL=thin:@localhost:1521:orcl CMR_METADATA_DB_PASSWORD=CMR_INGEST java -cp target/cmr-ingest-app-0.1.0-SNAPSHOT-standalone.jar cmr.db migrate
```
...
```
CMR_DB_URL=thin:@localhost:1521:orcl CMR_METADATA_DB_PASSWORD=CMR_INGEST java -cp target/cmr-ingest-app-0.1.0-SNAPSHOT-standalone.jar cmr.db drop-user
```
