 ...
 * `short-name` - An unique identifier of the provider. It is similar to `provider-id`, but more descriptive. It allows spaces and other special characters. `short-name` defaults to `provider-id`.
