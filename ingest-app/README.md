 ...
 * `consortiums` - A string of space delimited projects/efforts/tags(Example: CWIC GEOSS FEDEO) that a provider wants their collections automatically indexed with. Each project/effort/tag can only contain alphanumeric characters and underscores. Invalid consortiums is rejected at ingest. 
