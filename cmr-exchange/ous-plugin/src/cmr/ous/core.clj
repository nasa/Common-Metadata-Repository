(ns cmr.ous.core
  (:require
    ...
    [cmr.ous.impl.v3-1 :as v3-1]
    [taoensso.timbre :as log]))

(defn get-opendap-urls
  [component api-version user-token dap-version raw-params]
  ...
  (case (keyword api-version)
    ...
    :v3.1 (v3-1/get-opendap-urls component user-token dap-version raw-params)
