...
(defn archive-center-short-name->elastic-doc
  "Converts a archive-center into the portion going in an elastic document. If a field is not
  present in the KMS hierarchy we use a dummy value to indicate the field was not present."
