...
(def small-collections-index-alias
  "The index alias to use for the small collections index"
...
(defmapping granule-mapping :granule
  ...
  (merge
   {:concept-id m/string-field-mapping
    ...
    :readable-granule-name-lowercase-wildcard m/wildcard-field-mapping
  ...
  ([context index-set-id]
   (let [fetched-gran-index-set (index-set-es/get-index-set context es-config/gran-elastic-name index-set-id)
     ...
     {:index-names (get-in all-index-set [:index-set :concepts])
      :resharding-indices (elastic-search-index-names-cache/get-resharding-targets all-index-set)
