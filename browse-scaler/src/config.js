...
exports.TIMEOUT_INTERVAL = strToInt(process.env.EXTERNAL_REQUEST_TIMEOUT) || 15000;
console.log(
  '🚀 ~ file: config.js:14 ~ process.env.EXTERNAL_REQUEST_TIMEOUT:',
  process.env.EXTERNAL_REQUEST_TIMEOUT
);
