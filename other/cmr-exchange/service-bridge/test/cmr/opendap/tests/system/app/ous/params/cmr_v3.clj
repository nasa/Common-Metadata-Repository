(ns ^:system cmr.opendap.tests.system.app.ous.params.cmr-v3
  ...
  (testing "GET with variables, graules, and bounding box ..."
    (let [collection-id "C1200276794-HMR_TME"
          response @(httpc/get
                     ...
                     options)]
      (is (= 200 (:status response)))
      (is (= ["https://f5eil01.edn.ecs.nasa.gov/opendap/DEV01/user/FS2/AIRS/AIRX3STD.006/2016.01.01/AIRS.2016.01.01.L3.RetStd001.v6.0.31.0.G16004140142.hdf.dap.nc4?dap4.ce=/SurfPres_Forecast_A_VarBounds[22:1:34][169:1:200];/Latitude[22:1:34];/Longitude[169:1:200]"]
             (util/parse-response response))))))
