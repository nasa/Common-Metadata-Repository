...
(deftest pretty-print-xml-test
  ;; XML parsing library change caused small deviation in format
  #_(is (= pretty-printed-iso-xml (cx/pretty-print-xml iso-xml)))
  (is (> (count (string/split-lines (cx/pretty-print-xml iso-xml))) 5)))
