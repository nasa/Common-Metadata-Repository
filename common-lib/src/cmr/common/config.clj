...
(defn config-value
  "Retrieves the currently configured value for the name or the default value. A parser function can
  optionally be specified for parsing the value out of the environment variable which comes back as
  a string unless the parser function is provided. Prefer using the getter method generated by
  defconfig over this method."
  ([config-name default-value]
   (config-value config-name default-value nil))
