...
(defn migrate
  ...
  (let [elastic-store (l/start (search-index/create-elastic-search-index es-config/elastic-config) nil)
        gran-elastic-store (l/start (search-index/create-elastic-search-index es-config/gran-elastic-config) nil)]
    (ac-index/create-index-or-update-access-control-related-mappings elastic-store)
    (ac-index/create-index-or-update-access-control-related-mappings gran-elastic-store)))
