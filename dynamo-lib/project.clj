(defproject nasa-cmr/cmr-dynamo-lib "0.1.0-SNAPSHOT"
  :description "Contains utilities for connecting to and manipulating data in DynamoDB"
  :url "https://github.com/nasa/Common-Metadata-Repository/tree/master/dynamo-lib"
