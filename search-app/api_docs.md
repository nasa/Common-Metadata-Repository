...
These are query parameters specific to collections
  ...
  * `has_granules` - When set to "true" or "false", filters results to include only collections with or without granules, respectively. Supported in all response formats except opendata.
