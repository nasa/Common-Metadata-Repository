...
(deftest app-url->stac-urls-test
  (are [input expected]
    ...
    {:stac-url "https://cmr.earthdata.nasa.gov/stac"
     ...
     :stac-docs-url "https://d3hqnx562z478b.cloudfront.net/docs/index.html" 
    ...
    {:stac-url "https://cmr.sit.earthdata.nasa.gov/stac"
     ...
     :stac-docs-url "https://d3se4zjsrvasc2.cloudfront.net/docs/index.html"
    ...
    {:stac-url "https://cmr.uat.earthdata.nasa.gov/stac"
     ...
     :stac-docs-url "https://d346wn5qqiom8e.cloudfront.net/docs/index.html"
