...
;; referring the private get-search-results-format function into this namespace for testing
(def get-search-results-format (ns-resolve 'cmr.search.api.routes 'get-search-results-format))
...
(deftest get-search-results-format-test
  (testing "format from headers"
    (are [path headers default-mime-type expected-format]
         (=  expected-format (get-search-results-format path headers default-mime-type))
         ;; Accept header
