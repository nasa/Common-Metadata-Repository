...
(def resource-type->related-url-types
  ...
  {"STATIC URL" ["VIEW RELATED INFORMATION"]
   ...
   "GET DATA : OPENDAP DATA (DODS)" ["GET DATA" "OPENDAP DATA"]
   "USER SERVICE API : OPENDAP DATA" ["USE SERVICE API" "OPENDAP DATA"]
   "USER SERVICE API : OPENDAP DATA (DODS)" ["USE SERVICE API" "OPENDAP DATA"]
