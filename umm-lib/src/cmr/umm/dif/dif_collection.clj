(ns cmr.umm.dif.dif-collection
  ...
  (:require
   ...
   [cmr.umm.dif.collection.temporal :as temporal]
  ...
  (umm->dif-xml
    ([collection]
     (let [{{:keys [short-name version-id processing-level-id collection-data-type]} :product
       ...
       (xml/emit-str
         (xml/element :DIF dif-header-attributes
                    (xml/element :Entry_ID {} (eid/entry-id short-name version-id))
                    (xml/element :Entry_Title {} entry-title)
                    (when version-id
                      (xml/element :Data_Set_Citation {}
                    ...
                    (for [tk temporal-keywords]
                      (xml/element :Data_Resolution {} (xml/element :Temporal_Resolution {} tk)))
                    ...
                    (xml/element :Metadata_Version {} "VERSION 9.9.3")
                    (when insert-time
                      (xml/element :DIF_Creation_Date {} (str insert-time)))
                    (when update-time
                      (xml/element :Last_DIF_Revision_Date {} (str update-time)))
...
(def schema-location "schema/dif/dif_v9.9.3.xsd")
