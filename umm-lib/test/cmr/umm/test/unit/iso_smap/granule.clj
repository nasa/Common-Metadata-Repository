...
(def generated-granule
  ...
  (umm-g/map->UmmGranule
   {:granule-ur "!"
    :data-provider-timestamps #cmr.umm.umm_granule.DataProviderTimestamps{:insert-time #=(joda/date-time 0 "UTC")
                                                                          :update-time #=(joda/date-time 0 "UTC")}
    :collection-ref #cmr.umm.umm_granule.CollectionRef{:entry-title "0"}
    :temporal #cmr.umm.umm_granule.GranuleTemporal{:range-date-time #cmr.umm.umm_collection.RangeDateTime{:beginning-date-time #=(joda/date-time 0 "UTC")}}
    :orbit-calculated-spatial-domains [#cmr.umm.umm_granule.OrbitCalculatedSpatialDomain{:orbital-model-name ": !"
                                                                                         :orbit-number 0
                                                                                         :start-orbit-number 0
                                                                                         :stop-orbit-number 0
                                                                                         :equator-crossing-longitude -1.0
                                                                                         :equator-crossing-date-time #=(joda/date-time 0 "UTC")}]}))
