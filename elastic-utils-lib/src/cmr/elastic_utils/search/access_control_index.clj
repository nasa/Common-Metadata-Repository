...
(defn index-group
  ...
  (let [elastic-doc (group-concept-map->elastic-doc concept-map)
        ...
        elastic-store (esi/context->search-index context cmr.elastic-utils.config/elastic-name)]
    (m/save-elastic-doc
...
(defn unindex-group
  ...
  (m/delete-by-id (esi/context->search-index context cmr.elastic-utils.config/elastic-name)
                  group-index-name
                  group-type-name
                  concept-id
                  revision-id
...
(defn unindex-groups-by-provider
  ...
  (es-helper/delete-by-query (esi/context->conn context cmr.elastic-utils.config/elastic-name)
                     group-index-name
                     group-type-name
